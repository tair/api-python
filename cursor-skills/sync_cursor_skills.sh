#!/usr/bin/env bash
#
# Sync Cursor skills from cursor-skills/<name>/ to .cursor/skills/<name>/
# Run from anywhere: ./cursor-skills/sync_cursor_skills.sh
#
# Options:
#   --link    Symlink instead of copy (edits in cursor-skills/ apply immediately)
